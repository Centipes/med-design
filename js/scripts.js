...
window.addEventListener('DOMContentLoaded', event => {
    ...
    $('#arrow-map').css("transform", "translate(0, " + -(3*window.devicePixelRatio+1.25/window.devicePixelRatio) + "px)");
    $('.arrow-service').css('transform', 'translate(0,' + -(3.2*window.devicePixelRatio) + 'px)');
    console.log(-(3*window.devicePixelRatio+1.25/window.devicePixelRatio));
